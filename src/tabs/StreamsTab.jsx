    ...
    if (devices.length === 0) {
      return (
        <LiveEmptyState
          ...
          description="Watchtower is wired to your live database — no simulated data here. Register devices in Settings and their feeds appear here."
          facts={[
            ...
            return (
              <div key={d.id} className="bg-slate-900/60 border border-slate-800 rounded-xl overflow-hidden">
                ...
                <div className="p-3 flex items-center justify-between gap-2">
                  ...
                  <span className={`text-[10px] px-2 py-0.5 rounded-full border capitalize flex-shrink-0 ${statusStyle[d.status] ?? statusStyle.offline}`}>
                    {d.status}
                  </span>
                </div>
              </div>
